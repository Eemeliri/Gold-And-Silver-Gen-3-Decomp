...
enum {
    ...
    HEAL_LOCATION_NEW_BARK_TOWN_PLAYERS_HOUSE_1F,
    HEAL_LOCATION_ROUTE_32,
    HEAL_LOCATION_ROUTE26NORTH,
    HEAL_LOCATION_INDIGO_PLATEAU_POKEMON_CENTER,
    HEAL_LOCATION_AZALEA_TOWN_POKEMON_CENTER,
    HEAL_LOCATION_BLACKTHORN_CITY_POKEMON_CENTER,
    HEAL_LOCATION_CELADON_CITY_POKEMON_CENTER,
    HEAL_LOCATION_CERULEAN_CITY_POKEMON_CENTER,
    HEAL_LOCATION_CHERRYGROVE_CITY_POKEMON_CENTER,
    HEAL_LOCATION_CINNABAR_ISLAND_POKEMON_CENTER,
    HEAL_LOCATION_ECRUTEAK_CITY_POKEMON_CENTER,
    HEAL_LOCATION_FUCHSIA_CITY_POKEMON_CENTER,
    HEAL_LOCATION_GOLDENROD_CITY_POKEMON_CENTER,
    HEAL_LOCATION_LAVENDER_TOWN_POKEMON_CENTER,
    HEAL_LOCATION_MAHOGANY_TOWN_POKEMON_CENTER,
    HEAL_LOCATION_OLIVINE_CITY_POKEMON_CENTER,
    HEAL_LOCATION_PEWTER_CITY_POKEMON_CENTER,
    HEAL_LOCATION_SAFFRON_CITY_POKEMON_CENTER,
    HEAL_LOCATION_VERMILION_CITY_POKEMON_CENTER,
    HEAL_LOCATION_VIOLET_CITY_POKEMON_CENTER,
    HEAL_LOCATION_VIRIDIAN_CITY_POKEMON_CENTER,
